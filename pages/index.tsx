              ...
              <div className="row align-items-center px-lg-5 mx-auto gap-lg-0 gap-4">
                  ...
                  <div className="col-lg-5 col-12 ps-lg-60">
                      <div className="">
                          ...
                          <p className="text-lg color-palette-1 mb-30" />Kami menyediakan jutaan cara untuk <br className="d-sm-block d-none" /> membantu players menjadi<div className="d-sm-block d-none"> pemenang sejati
